...
namespace teensy_serial_demo
{
    public partial class Form1 : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            int numSteps = Convert.ToInt16(Math.Abs(numericUpDown2.Value));
            byte stepDir = 0x01;
            int delayMs = Convert.ToInt16(numericUpDown3.Value);
            ...
            // parse individual bytes from the string
            const byte stepperPacketDescriptor = 0x06;
            byte[] payloadBuffer = {stepperPacketDescriptor, stepDir};
            int payloadLength = 2;
            ...
            if(checkBox1.Checked)
            {
                // send a packet for each step while pausing between packets
